...
from web.services.db_inst import dbinstcrtquery, db_inst_crt_query, db_inst_create, db_inst_destroy, db_inst_log, \
    db_inst_manager
from web.services.db_inst import dbinstparaquery, dbinstpara_query, dbinstparaadd_save, dbinstparaedit_save, \
    dbinstparaedit_del, dbinstoptlogquery, dbinstoptlog_query
from web.services.db_inst import dbinstquery, db_inst_query, db_inst_save, db_inst_update, db_inst_query_by_id, \
    dbinstmgr, get_tree_by_inst, db_inst_sql_query, db_inst_delete, get_inst_tab_ddl, get_inst_idx_ddl, drop_inst_tab
from web.services.db_user import dbuserquery, db_user_query, db_user_save, db_user_update, db_user_delete, db_user_sql, \
    db_user_dbs, db_user_info, db_user_query_by_id
