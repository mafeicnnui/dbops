...
from web.services.minio import minioquery, minio_query, minioadd, minioadd_save, miniochange, minioedit, minioedit_save, \
    minioedit_del, minioedit_push, minioclone
