...
from web.services.logon import forget_password, forget_password_check_user, forget_password_check_auth, \
    forget_password_check_pass, update_token, logout_page
from web.services.logon import index, main, platform, easylife, logon, logout, logon_check, get_tree, get_time, \
    get_verify, error
