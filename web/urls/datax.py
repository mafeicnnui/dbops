...
from web.services.datax import sync_datax_downloads_dataxTemplete, syncchange_datax, syncedit_datax, \
    syncedit_save_datax, syncedit_del_datax, syncedit_push_datax
from web.services.datax import sync_datax_query_es_dataxTemplete, sync_datax_downloads_es_dataxTemplete, \
    sync_datax_query_doris_dataxTemplete
from web.services.datax import syncadd_datax, syncadd_datax_save, syncdataxquery, sync_datax_query, \
    sync_datax_query_detail, sync_datax_query_dataxTemplete
from web.services.datax import syncedit_pushall_datax, syncedit_run_datax, syncedit_stop_datax, syncclone_datax, \
    syncclone_save_datax, syncloganalyze_datax, sync_log_analyze_datax, get_datax_sync_tasks
