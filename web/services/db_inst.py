...
from web.model.t_db_inst import create_db_inst, destroy_db_inst, log_db_inst, manager_db_inst, update_db_config, \
    query_db_config
from web.model.t_db_inst import get_tree_by_instid, exe_query, del_db_inst, get_tab_ddl_by_instid, \
    get_idx_ddl_by_instid, drop_tab_by_instid
from web.model.t_db_inst import query_db_inst_para, save_db_inst_para, upd_db_inst_para, del_db_inst_para, \
    query_db_inst_log
