...
from web.model.t_dmmx import get_db_sync_tags_by_market_id, get_db_sync_ywlx_by_market_id, get_datax_sync_tags, \
    get_datax_sync_db_server_doris
from web.model.t_dmmx import get_dmm_from_dm, get_dmm_from_dm2, get_sync_server, get_datax_sync_db_server, \
    get_db_sync_tags
from web.model.t_sync_datax import push_datax_sync_task, pushall_datax_sync_task, run_datax_sync_task, \
    stop_datax_sync_task, update_datax_sync_status
from web.model.t_sync_datax import query_datax_sync, save_datax_sync, query_datax_by_id, upd_datax_sync, del_datax_sync, \
    query_datax_sync_log
from web.model.t_sync_datax import query_datax_sync_detail, query_datax_sync_dataxTemplete, \
    downloads_datax_sync_dataxTemplete, get_datax_sync_tags_by_env
...
class syncedit_datax(base_handler.TokenHandler):
    async def get(self):
        ...
        self.render("./datax/sync_datax_edit.html",
                    ...
                    dm_doris_db_names=[] if d_sync['doris_id'] == '' else await get_datax_sync_db_names_doris(
                        d_sync['doris_id']),
